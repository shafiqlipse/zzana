...
class User(AbstractUser):
    ...
    thumbnail = models.ImageField(upload_to='profile_images/', null=True, blank=True)
...
class Notice(models.Model):
    ...
    attachment = models.FileField(upload_to='noticeboard/attachments/', null=True, blank=True)
    ...
    class Meta:
        ordering = ['-created_at']  # Display notices in descending order of creation
