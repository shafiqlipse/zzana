...
(window.theme = theme),
  (function () {
    "use strict";
    var e;
    document.getElementById("perfomanceChart") &&
      ((e = {
        series: [100, 78, 89],
      ...
      new ApexCharts(document.querySelector("#perfomanceChart"), e).render()),
      document.getElementById("revenueChart") &&
        ((e = {
          series: [
            { name: "Current Week", data: [31, 40, 28, 51, 42, 109, 100] },
      ...
      document.getElementById("chartGraphics") &&
        ((e = {
          ...
          plotOptions: {
            bar: { horizontal: !1, columnWidth: "65%", endingShape: "rounded" },
          },
          dataLabels: { enabled: !1 },
          legend: { show: !1 },
      ...
      document.getElementById("socialTraffic") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#socialTraffic"), e).render()),
      document.getElementById("chartCampaign") &&
        ((e = {
          series: [
            {
              name: "Campaign Sent",
        ...
        new ApexCharts(document.querySelector("#chartCampaign"), e).render()),
      ...
      document.getElementById("chartCampaignEmail") &&
        ((e = {
          series: [55, 33, 12],
      ...
      document.getElementById("chartRevenue") &&
        ...
        new ApexCharts(document.querySelector("#chartRevenue"), e).render()),
      ...
      document.getElementById(".taskPrototypeChart") &&
        ((e = {
          series: [75],
      ...
      document.getElementById(".taskContentChart") &&
        ((e = {
          series: [85],
          chart: { height: 40, width: 40, type: "radialBar" },
          grid: {
      ...
      document.getElementById(".taskFigmaChart") &&
        ((e = {
          series: [40],
          chart: { height: 40, width: 40, type: "radialBar" },
          grid: {
      ...
      document.getElementById(".taskInterfaceChart") &&
        ((e = {
          series: [35],
          chart: { height: 40, width: 40, type: "radialBar" },
          grid: {
      ...
      document.getElementById(".taskWireframeChart") &&
        ((e = {
          series: [65],
          chart: { height: 40, width: 40, type: "radialBar" },
          grid: {
      ...
      document.getElementById("budgetExpenseChart") &&
        ((e = {
          ...
          fill: { colors: "#754ffe", opacity: 0.2 },
          colors: [window.theme.primary],
          dataLabels: {
            enabled: !0,
      ...
      document.getElementById("storeOne") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeOne"), e).render()),
      document.getElementById("storeTwo") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeTwo"), e).render()),
      document.getElementById("storeThree") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeThree"), e).render()),
      document.getElementById("storeFour") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeFour"), e).render()),
      document.getElementById("storeFive") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeFive"), e).render()),
      document.getElementById("storeSix") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeSix"), e).render()),
      document.getElementById("storeSeven") &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#storeSeven"), e).render()),
      document.getElementById("storeEight") &&
        ((e = {
          series: [{ data: [26, 15, 48, 12, 47, 19, 35, 19, 85, 68, 50] }],
          chart: { type: "area", height: 80, sparkline: { enabled: !0 } },
          fill: {
        ...
        new ApexCharts(document.querySelector("#storeEight"), e).render()),
      document.getElementById("visitorBlog") &&
        ((e = {
          series: [
            {
              name: "Visitor",
        ...
        new ApexCharts(document.querySelector("#visitorBlog"), e).render()),
      document.getElementById("blogTrafficChart") &&
        ((e = {
          series: [42, 27, 32],
        ...
        new ApexCharts(
          document.querySelector("#blogTrafficChart"),
          e
        ).render()),
      document.getElementById("cashFlowChart") &&
        ...
        new ApexCharts(document.querySelector("#cashFlowChart"), e).render()),
      document.getElementById("dealRoportChart") &&
        ((e = {
          series: [
            { name: "Won", data: [80, 50, 30, 40, 100, 20] },
            { name: "Pending", data: [20, 30, 40, 80, 20, 80] },
        ...
        new ApexCharts(document.querySelector("#dealRoportChart"), e).render()),
